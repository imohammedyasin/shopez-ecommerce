...
const UpdateProduct = () => {
  ...
  const fetchProduct = async() =>{
    await axios.get(`/api/products/fetch-product-details/${id}`).then(
      (response)=>{
  ...
  const fetchCategories = async () =>{
    await axios.get('/api/products/fetch-categories').then(
      (response)=>{
  ...
  const handleUpdateProduct = async() =>{
    await axios.put(`/api/products/update-product/${id}`, {productName, productDescription, productMainImg, productCarousel: [productCarouselImg1, productCarouselImg2, productCarouselImg3], productSizes, productGender, productCategory, productNewCategory, productPrice, productDiscount}).then(
      (response)=>{
